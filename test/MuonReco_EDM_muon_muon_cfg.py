...
process.load("PhysicsTools.TagAndProbe.tag_probe_muon_muon_cfi")
...
process.TPEdm = cms.EDFilter("TagProbeEDMNtuple",
    allProbeTruthMatchMapTags = cms.untracked.VInputTag(cms.InputTag("generalMCMatch"), cms.InputTag("staMCMatch"), cms.InputTag("staTkMCMatch"), cms.InputTag("generalMCMatch")),
    ...
    allProbeCandTags = cms.untracked.VInputTag(cms.InputTag("generalCands"), cms.InputTag("staCands"), cms.InputTag("staTkMatched"), cms.InputTag("generalCands")),
    # Trigger & Trigger Matching tags
    triggerEventTag = cms.untracked.InputTag("hltTriggerSummaryRAW"),
    passProbeTruthMatchMapTags = cms.untracked.VInputTag(cms.InputTag("tkStaMCMatch"), cms.InputTag("staTkMCMatch"), cms.InputTag("glbWithStaMCMatch"), cms.InputTag("glbWithTkMCMatch")),
    # Tag & Probe Muon Candidate Collections
    tagCandTags = cms.untracked.VInputTag(cms.InputTag("glbCands"), cms.InputTag("glbCands"), cms.InputTag("glbCands"), cms.InputTag("glbCands")),
    ...
    tagProbeMapTags = cms.untracked.VInputTag(cms.InputTag("tagGlbprobeTkMap"), cms.InputTag("tagGlbprobeStaMap"), cms.InputTag("tagGlbprobeGlbStaMap"), cms.InputTag("tagGlbprobeGlbTkMap")),
    ...
    # Truth Map Tags
    tagTruthMatchMapTags = cms.untracked.VInputTag(cms.InputTag("glbMCMatch"), cms.InputTag("glbMCMatch"), cms.InputTag("glbMCMatch"), cms.InputTag("glbMCMatch")),
    # Store some generic information about the event
    # in case we want it
    mcParticles = cms.untracked.vint32(23, 13, 22),
    passProbeCandTags = cms.untracked.VInputTag(cms.InputTag("tkStaMatched"), cms.InputTag("staTkMatched"), cms.InputTag("glbWithStaTkMatched"), cms.InputTag("glbWithTkMatched")),
...
process.outpath = cms.OutputModule("PoolOutputModule",
    outputCommands = cms.untracked.vstring('drop *', 
        'keep *_TPEdm_*_*'),
    fileName = cms.untracked.string('output/muon_muon_EDM.root')
)
